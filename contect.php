...
<body>
	<div id="full">
		<div  style="background-image: url('img/hms8.webp');background-size: 100% 710px; width: 100%; height: 710px">
		<div id="header">
			<div id="logo">
		...
		<div id="banner"><br><br><br><br><br><br><br><br><br><br>
			<center><div style="background:rgba(255,230,220,.8); width: 80%;height: 400px;">
