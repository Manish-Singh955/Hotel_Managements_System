...
<head>
	...
	<link href="img/hms8.webp" type="img/icon" rel="icon">
	
</head>
<body>
	<div id="full">
		<div style="background-image: url('img/hms14.avif'); width:100%;height: 600px; ">
		<div id="header">
			<div id="logo">
				<h1><font color="yellow">M$ HOTEL</font></h1>
			</div>
	...
	<div id="welcome">
		<h1 align="center">WELCOME TO HOTEL										</h1>
		<center><font size="4">
