...
<body>
	<div id="full">
		<div id="bg" style="background-image: url('img/hms7.avif'); height: 1200px;">
		<div id="header">
			<div id="logo">
				<h1><font color="white">M$ HOTEL</font></h1>
			</div>
			<div id="nav">
				<ul>
		...
		<div id="banner">
			...
			<table style="color: yellow;">
				...
				<tr>
					...
					<td>ID no.</td>
					<td><input type="text" name="ID NUMBER" placeholder="Enter ID" title="ID"></td>
				</tr>
				...
				<tr>
					<td>Enter E-mail</td>
					<td><input type="text" name="E-MAIL" placeholder="Enter E-mail" title="E-mail"></td>
				</tr>
				<tr>
					<td>Checkin date</td>
